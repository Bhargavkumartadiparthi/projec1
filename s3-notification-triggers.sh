...
bucket_name="abhishek-ultimate-bucket1"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns1"
email_address="bhargavtadiparthi@gmail.com"

# Create IAM Role for the project
role_response=$(aws iam create-role --role-name s3-lambda-sns1 --assume-role-policy-document '{
  "Version": "2012-10-17",
  "Statement": [{
...
topic_arn=$(aws sns create-topic --name s3-lambda-sns1 --output json | jq -r '.TopicArn')
